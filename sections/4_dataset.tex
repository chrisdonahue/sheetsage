...
%Formally, we construct an alignment function $\texttt{Align} : [0,S) \to [0,T)$ that assigns each of $S$ beats in the metrical structure to a time $t \in [0,T)$ in the audio.
