...
%collecting aligned data for this task is much more difficult compared to tasks like piano transcription, where a Disklavier can be used to create training data in real time.
%\pl{should mention Disklavier and how it's not just data but aligned data?}
...
% 0.744 vs 0.420 = 77%
up to $77$\% 
relative \pl{hard to understand relative - should maybe provide absolute numbers?} to the strongest available baseline. 
