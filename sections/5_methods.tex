...
We propose a \beatpooling{} of audio features $\bm{X} \in \mathbb{R}^{Tf_k \times d}$ to yield features that are uniformly spaced in subdivisions of the beat (as defined by the alignments constructed in \Cref{sec:align}) rather than in time. 
