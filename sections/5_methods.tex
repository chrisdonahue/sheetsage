...
Our approach effectively resamples audio features \bm{X} from being evenly spaced in time to being evenly spaced in beats. 
...
\todo{Reconcile this with new notation from task section}