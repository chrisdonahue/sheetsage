...
%\pl{is this jointly trained with the melody transcription? actually I don't remember if we're doing probing with an MLP?}
% CHRIS: Not jointly trained, though it certainly could be.
...
% %only handle $3$/$4$ or $4$/$4$ time signatures and cannot handle key or time signature changes. 
